...
Road-In은 대학생이 지도 위에서 목적지를 향해 이동하듯 공모전, 팀원 모집, 멘토링, 커뮤니티 활동을 관리하는 캠퍼스 성장 지도 서비스입니다. 사용자는 관심 분야와 역량에 맞는 공모전과 팀을 탐색하고, 멘토링 일정을 확인하며, 마이페이지에서 활동 이력과 코인 미션을 관리할 수 있습니다.
